...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { company: @employer.company, email: @employer.email, first_name: @employer.first_name, last_name: @employer.last_name, phone: @employer.phone }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { company: @employer.company, email: @employer.email, first_name: @employer.first_name, last_name: @employer.last_name, phone: @employer.phone }
    assert_redirected_to employer_path(assigns(:employer))
  end
