...
Candidate.create(first_name: 'Rebecca', last_name: 'Dymond', email: 'Rebecca@dymond.com', phone: '92384-384', password_digest: 'pass', profile_image: '../assets/images/bec-pippa.jpeg')
